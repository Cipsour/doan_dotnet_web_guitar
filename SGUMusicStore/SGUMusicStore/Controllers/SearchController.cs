...
namespace SGUMusicStore.Controllers
{
    public class SearchController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "nameProduct,idProduct,sizeS,sizeM,sizeL,price,description,idType")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "nameProduct,idProduct,sizeS,sizeM,sizeL,price,description,idType")] Product product)
        {
            if (ModelState.IsValid)
            {
