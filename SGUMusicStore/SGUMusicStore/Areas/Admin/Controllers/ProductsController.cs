...
namespace SGUMusicStore.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "nameProduct,idProduct,sizeS,sizeM,sizeL,price,description,idType")] Product product, HttpPostedFileBase img1, HttpPostedFileBase img2)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "nameProduct,idProduct,sizeS,sizeM,sizeL,price,description,idType")] Product product ,HttpPostedFileBase img1, HttpPostedFileBase img2)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
                if (ModelState.IsValid)
