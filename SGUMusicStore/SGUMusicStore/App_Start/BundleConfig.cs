...
namespace SGUMusicStore
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //layout
            bundles.Add(new StyleBundle("~/Content/layout").Include("~/Content/base.css","~/Content/header.css", "~/Content/footer.css"));

            //main
            bundles.Add(new StyleBundle("~/Content/main").Include("~/Content/main.css"));
            //base
            bundles.Add(new StyleBundle("~/Content/base").Include("~/Content/base.css"));
            //footer
            bundles.Add(new StyleBundle("~/Content/footer").Include("~/Content/footer.css"));
            ...
            //checkout 
            bundles.Add(new StyleBundle("~/Content/checkout").Include("~/Content/checkout.css"));

            //payment
            bundles.Add(new StyleBundle("~/Content/payment").Include("~/Content/payment.css"));
            ...
            //product
            bundles.Add(new StyleBundle("~/Content/product").Include("~/Content/product.css"));
            ...
            /*   admin*/
            bundles.Add(new StyleBundle("~/Content/admin/base").Include("~/Content/admin/base.css"));
            bundles.Add(new StyleBundle("~/Content/admin/bstr").Include("~/Content/admin/bootstrap.min.css"));
            bundles.Add(new StyleBundle("~/Content/admin/custom").Include("~/Content/admin/custom.css"));
            bundles.Add(new StyleBundle("~/Content/admin/index").Include("~/Content/admin/index.css"));

            bundles.Add(new StyleBundle("~/Content/admin/style").Include("~/Content/admin/style.css"));
